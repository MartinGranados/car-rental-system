...
def filters(request):
    ...
    if request.method == 'POST':
        ...
        # rental_length = {'rental_length': int(str(status_end.date() - status_start.date()).split(' ')[0])}
        # print(rental_length)
            ...
            if request.POST['vehicle_class'] == 'any':
                ...
                if request.POST['number_of_seats'] == 'any':
                    ...
                    filtered_vehicles = {'vehicles': Vehicle.objects.filter(vehicle_status='Available', 
                                                                            ...
                                                                            seats=request.POST['number_of_seats'],
                                                                            status_start_date__lte=status_start.date(),
                                                                            status_end_date__gte=status_end.date()), 'rental_length': rental_length}
...
#         return render(request, 'reservations/filtered.html', filtered_vehicles)
